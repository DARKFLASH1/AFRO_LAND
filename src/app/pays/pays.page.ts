...
export class PaysPage implements OnInit {
  ...
  private infosPays: { [key: string]: any } = {
    ...
    'soudan': {
      ...
      culture: { languages: ['Arabe', 'Nubien'] },
    ...
    'mauritanie': {
      ...
      culture: { languages: ['Arabe hassaniya', 'Pulaar', 'Soninké', 'Wolof'] },
    ...
    'gambie': {
      ...
      culture: { languages: ['Anglais', 'Mandingue', 'Wolof', 'Fula'] },
    ...
    'guinee': {
      ...
      culture: { languages: ['Français', 'Pular', 'Mandingue', 'Susu'] },
    ...
    'guinee-bissau': {
      ...
      culture: { languages: ['Portugais', 'Créole', 'Balanta', 'Fula'] },
    ...
    'liberia': {
      ...
      culture: { languages: ['Anglais', 'Kpelle', 'Bassa'] },
    ...
    'niger': {
      ...
      history: { independence: '1960', colonisateur: 'France' },
      culture: { languages: ['Français', 'Haoussa', 'Zarma', 'Tamasheq'] },
    ...
    'sierra-leone': {
      ...
      culture: { languages: ['Anglais', 'Krio', 'Mende', 'Temne'] },
    ...
    'centrafrique': {
      ...
      history: { independence: '1960', colonisateur: 'France' },
      culture: { languages: ['Français', 'Sango'] },
    ...
    'tchad': {
      ...
      history: { independence: '1960', colonisateur: 'France' },
      culture: { languages: ['Français', 'Arabe tchadien', 'Sara'] },
    ...
    'congo-brazzaville': {
      ...
      history: { independence: '1960', colonisateur: 'France' },
      culture: { languages: ['Français', 'Kituba', 'Lingala'] },
    ...
    'guinee-equatoriale': {
      ...
      culture: { languages: ['Espagnol', 'Français', 'Portugais', 'Bubi', 'Fang'] },
    ...
    'gabon': {
      ...
      history: { independence: '1960', colonisateur: 'France' },
      culture: { languages: ['Français', 'Fang', 'Myene'] },
      economy: { mainSectors: ['Pétrole', 'Manganèse', 'Bois', 'Tourisme'], exports: ['Pétrole', 'Manganèse (2e mondial)', 'Bois'] },
      highlights: ['Parc national de Lopé (UNESCO)', 'Parc national de la Lopé', 'Gorilles et éléphants de forêt', 'Réserve de la Lopé'],
    ...
    'saotome': {
      ...
      history: { independence: '1975', colonisateur: 'Portugal' },
      culture: { languages: ['Portugais', 'Forro', 'Angolar'] },
    ...
    'burundi': {
      ...
      culture: { languages: ['Kirundi', 'Français', 'Swahili'] },
    ...
    'djibouti': {
      ...
      culture: { languages: ['Français', 'Arabe', 'Somali', 'Afar'] },
    ...
    'erythree': {
      ...
      culture: { languages: ['Tigrigna', 'Arabe', 'Anglais'] },
    ...
    'somalie': {
      ...
      culture: { languages: ['Somali', 'Arabe'] },
    ...
    'soudan-du-sud': {
      ...
      culture: { languages: ['Anglais', 'Arabe', 'Dinka', 'Nuer'] },
    ...
    'comores': {
      ...
      culture: { languages: ['Shikomori', 'Arabe', 'Français'] },
    ...
    'seychelles': {
      ...
      culture: { languages: ['Créole seychellois', 'Anglais', 'Français'] },
      ...
      drapeaux: ['assets/images/aeychelles.jpg']
    },
    ...
    'botswana': {
      ...
      culture: { languages: ['Tswana', 'Anglais'] },
    ...
    'eswatini': {
      ...
      history: { independence: '1968', colonisateur: 'Royaume-Uni' },
      culture: { languages: ['Swati', 'Anglais'] },
    ...
    'lesotho': {
      ...
      history: { independence: '1966', colonisateur: 'Royaume-Uni' },
      culture: { languages: ['Sesotho', 'Anglais'] },
    ...
    'malawi': {
      ...
      culture: { languages: ['Chichewa', 'Anglais'] },
    ...
    'namibie': {
      ...
      culture: { languages: ['Anglais', 'Afrikaans', 'Oshiwambo', 'Otjiherero', 'Allemand'] },
    ...
    'zambie': {
      ...
      history: { independence: '1964', colonisateur: 'Royaume-Uni' },
      culture: { languages: ['Anglais', 'Bemba', 'Nyanja', 'Tonga'] },
    ...
    'angola_australe': {
      ...
      history: { independence: '1975', colonisateur: 'Portugal' },
      culture: { languages: ['Portugais', 'Umbundu', 'Kimbundu'] },
  ...
  onSegmentChange(e: any) { const v = e.detail.value; if (v) this.defilerVersSection(v); }
